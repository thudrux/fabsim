...
public class ComponentGroupedEventListManagerWithZeroDelayList implements IEventListManager {
	...
	public ComponentGroupedEventListManagerWithZeroDelayList() {

	}

	public ComponentGroupedEventListManagerWithZeroDelayList(boolean useZeroDelayList) {
//		logger.debug("Initializing ComponentGroupedEventListManager useZeroDelayList={}", useZeroDelayList);
		this.useZeroDelayList = useZeroDelayList;
	}

	public ISimEvent getNextEvent() {
//		logger.debug("getNextEvent()");
		if (useZeroDelayList) {
...
//		System.out.println("scheduling event to component map");
