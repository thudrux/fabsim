...
public class EventComparatorTest {
	...
	public void orderTest1() {
		...
		ISimEvent event1 = new BreakdownTriggeredEvent(model,0L, null, new SimTimeBasedBreakdown(model,"breakdown", null, null));
		ConstantDurationObject obj1 = new ConstantDurationObject(1L);
		ConstantDurationObject obj10 = new ConstantDurationObject(10L);
		ISimEvent event2 = new MaintenanceTriggeredEvent(model,0L, null, new SimTimeBasedMaintenance(model,"Maintenance", obj1, obj10));
