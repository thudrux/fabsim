...
public class SimulationResultAggregatorTest {
	...
	public void emptyRecipeSimResultAggregatorTest() {
		...
		assertEquals(0.0, overview.getAvgCycleTime(),0.001);
		assertEquals(0.0, overview.getAvgWIP(),0.001);
		assertEquals(0.0, overview.getCycleTimeVariance(),0.001);
		assertEquals(1, overview.getMaxWIP());
		assertEquals(0.0, overview.getFlowFactor(),0.001);
	}
	...
	public void simpleRecipeSimResultAggregatorTest() {
		...
		assertEquals(4.0, overview.getAvgCycleTime(),0.001);
		assertEquals(0.5, overview.getAvgWIP(),0.001);
	//	assertEquals(0.0, overview.getCycleTimeVariance(),0.001);
		assertEquals(1, overview.getMaxWIP());
		assertEquals(1.0, overview.getFlowFactor(),0.001);
	}
