...
import de.terministic.fabsim.statistics.SimulationLog;
...
public class BasicDedicationTest {
	...
	public void setUp() throws Exception {
		...
		tgStep2 = model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step2", toolGroup, 3L, ProcessType.LOT,recipe);
