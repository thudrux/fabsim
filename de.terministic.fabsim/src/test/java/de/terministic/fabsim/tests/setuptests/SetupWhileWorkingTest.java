...
public class SetupWhileWorkingTest {
	...
	public void setUp() throws Exception {
		...
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step1", toolGroup, 10L, s1, ProcessType.LOT,
				recipe);
	...
	public void WhileWorkingTest() {
		...
		Assertions.assertEquals(s1, toolLogList.get(toolLogList.size() - 1).getSetupState());
	}
