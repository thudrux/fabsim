...
public class DelayTest {
	...
	public void setUp() throws Exception {
		...
		tgStep1 = model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step1", toolGroup, 2L, ProcessType.LOT,recipe);
		tgStep2 = model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step2", toolGroup2, 3L, ProcessType.LOT,recipe);
	...
	public void countTestWithTwoMachines() {
		...
		assertEquals(25L, counter.getItemCount()); //in 25 runs are 25 lots generated
	}
	...
	public void processStepTimeTestWithTwoMachines() {
		...
		assertEquals(2L, tgStep1.getDuration(null)); // test if the delay of machine 1 is 2 seconds
	}
	...
	public void cycleTimeTestOneJobWithTwoMachines() {
		...
		assertEquals(5L, cycleTime.getCycleTime());
	...
	public void cycleTimeChangeDurationWithTwoMachines() {
		...
		long durationStep1 = 7L ; long durationStep2 = 11L;
		...
		assertEquals((durationStep1+durationStep2), cycleTime.getCycleTime());
...
//		FlowItemDestructionEvent destruct = new FlowItemDestructionEvent();
	...
	//	System.out.println( cycleTime.getCycleTime());
		assertEquals(5L, counter.getItemCount());  // in 5 sec are 5 lots generated
