...
public class OperatorBasicTest {
	...
	public void simpleOperatorBlockUsageTest() {
		...
		this.toolGroup = (AbstractHomogeneousResourceGroup) this.model.getSimComponentFactory().createToolGroup("ToolGroup1", 1, ProcessingType.LOT);
		...
		this.model.getSimComponentFactory().createProcessStepAndAddToRecipe("lastStep", sink, 0L, ProcessType.LOT, recipe);
		...
		final AbstractHomogeneousResourceGroup toolGroupOpBlock = (AbstractHomogeneousResourceGroup) this.model.getSimComponentFactory().createToolGroup("OpBlock", 1,
				ProcessingType.LOT);
		...
		this.model.getSimComponentFactory().createProcessStepAndAddToRecipe("BlockSinkStep", blockSink, 0L, ProcessType.LOT,
				blockRecipe);
		...
		assertEquals(4, toolLogList.size());

		assertEquals(45L, toolLogList.get(1).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR,toolLogList.get(1).getNewState());

		assertEquals(50L, toolLogList.get(2).getTime());
		assertEquals(SemiE10EquipmentState.PR, toolLogList.get(2).getNewState());

		assertEquals(57L, toolLogList.get(3).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, toolLogList.get(3).getNewState());
	}
	...
	public void operatorBlockingLoadUnloadTest(){
		...
		AbstractHomogeneousResourceGroup toolGroup1 = (AbstractHomogeneousResourceGroup) model.getSimComponentFactory().createToolGroup("ToolGroup1", 1, ProcessingType.LOT);
		...
		//TG2 mit 1 Tool
		//Load Processing Unload 75%
		AbstractHomogeneousResourceGroup toolGroup2 = (AbstractHomogeneousResourceGroup) model.getSimComponentFactory().createToolGroup("ToolGroup2", 1, ProcessingType.LOT);
		toolGroup2.setOpLoadPercentage(75);
		toolGroup2.setOpProcessingPercentage(75);
		toolGroup2.setOpUnloadPercentage(75);
		
		//DummyTG mit 1 Tool 
		AbstractToolGroup dummyToolGroup = model.getSimComponentFactory().createToolGroup("DummyGroup", 1, ProcessingType.LOT);
		...
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step_1_1", toolGroup1, ops, 40L, 60L, 80L, null, null, ProcessType.LOT, recipe1);
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("sinkStep_1", sink1, 0L, ProcessType.LOT, recipe1);
		...
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step_2_1", dummyToolGroup, 1L, null, null, ProcessType.LOT, recipe2);
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("Step_2_2", toolGroup2, ops, 16L, 24L, 4L, null, null, ProcessType.LOT, recipe2);
		model.getSimComponentFactory().createProcessStepAndAddToRecipe("sinkStep_1", sink2, 0L, ProcessType.LOT, recipe2);
		//Source 1 Los bei 0, Intervall 500
		...
		assertEquals(3,dummyLog.size());
		
		assertEquals(0L, dummyLog.get(0).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, dummyLog.get(0).getNewState());

		assertEquals(0L, dummyLog.get(1).getTime());
		assertEquals(SemiE10EquipmentState.PR, dummyLog.get(1).getNewState());
		
		assertEquals(1L, dummyLog.get(2).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, dummyLog.get(2).getNewState());
		
		
		//Equipment Log TG1 0=>PR 40=>SB_NO_OPERATOR 42=>PR 102=>SB_NO_OPERATOR 105=>PR 185 => SB_NO_MATERIAL
		List<ToolStateLogEntry> tool1Log =log.getLog().get(toolGroup1.getToolByIndex(0));
		assertEquals(7, tool1Log.size());

		assertEquals(0L, tool1Log.get(0).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, tool1Log.get(0).getNewState());
		
		assertEquals(0L, tool1Log.get(1).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool1Log.get(1).getNewState());
		
		assertEquals(40L, tool1Log.get(2).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR, tool1Log.get(2).getNewState());
		
		assertEquals(42L, tool1Log.get(3).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool1Log.get(3).getNewState());
		
		assertEquals(102L, tool1Log.get(4).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR, tool1Log.get(4).getNewState());
		
		assertEquals(105L, tool1Log.get(5).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool1Log.get(5).getNewState());
		
		assertEquals(185L, tool1Log.get(6).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, tool1Log.get(6).getNewState());
		
		//Equipment Log TG2 1=>SB_NO_OPERATOR 30=>PR 46=>SB_NO_OPERATOR 87=>PR 111=>SB_NO_OPERATOR 165=>PR 169=>SB_NO_MATERIAL
		List<ToolStateLogEntry> tool2Log =log.getLog().get(toolGroup2.getToolByIndex(0));
		assertEquals(8, tool2Log.size());

		assertEquals(0L, tool2Log.get(0).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, tool2Log.get(0).getNewState());
		
		assertEquals(1L, tool2Log.get(1).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR, tool2Log.get(1).getNewState());
		
		assertEquals(30L, tool2Log.get(2).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool2Log.get(2).getNewState());
		
		assertEquals(46L, tool2Log.get(3).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR, tool2Log.get(3).getNewState());
		
		assertEquals(87L, tool2Log.get(4).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool2Log.get(4).getNewState());
		
		assertEquals(111L, tool2Log.get(5).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_OPERATOR, tool2Log.get(5).getNewState());
		
		assertEquals(165L, tool2Log.get(6).getTime());
		assertEquals(SemiE10EquipmentState.PR, tool2Log.get(6).getNewState());
		
		assertEquals(169L, tool2Log.get(7).getTime());
		assertEquals(SemiE10EquipmentState.SB_NO_MATERIAL, tool2Log.get(7).getNewState());
	...
	public void simpleOperatorTest(){
		...
		assertEquals(7L, tracker.getCycleTime());
	...
	public void operatorBreakdownTest(){
		...
		this.toolGroup = (AbstractHomogeneousResourceGroup) model.getSimComponentFactory().createToolGroup("ToolGroup", 1, ProcessingType.LOT);
		this.toolGroup.setOpProcessingPercentage(100);
		...
		model.getSimComponentFactory().createSimulationTimeBasedBreakdownAndAddToToolGroup("SmallBreakdown", mttr, mtbf, toolGroup);
		...
		assertEquals(12L, tracker.getCycleTime());
	}
