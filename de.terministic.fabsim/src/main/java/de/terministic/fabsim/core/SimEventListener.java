...
public abstract class SimEventListener {
	private Set<AbstractComponent> componentFilter = new HashSet<>();
	protected Logger logger = LoggerFactory.getILoggerFactory().getLogger(this.getClass().getName());

	public void addComponentFilter(final AbstractComponent abstractComponent) {
	...
	public void setComponentFilter(final Set<AbstractComponent> components) {
